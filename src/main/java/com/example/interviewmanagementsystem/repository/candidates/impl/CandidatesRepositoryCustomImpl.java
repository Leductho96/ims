package com.example.interviewmanagementsystem.repository.candidates.impl;
...
import com.example.interviewmanagementsystem.repository.candidates.CandidatesRepositoryCustom;
...
public class CandidatesRepositoryCustomImpl implements CandidatesRepositoryCustom {
    ...
    public CandidatePositionDTO getPositionById(Integer id){
         ...
         return entityManager.createQuery("select new com.example.interviewmanagementsystem.util.dto.candidates.CandidatePositionDTO(p.positionName) from Candidates c join c.position p where c.id=:id",CandidatePositionDTO.class)
                 .setParameter("id",id)
                 .getSingleResult();
    }
    ...
    public CandidateRecruiterDTO getRecruiterById(Integer id){
        ...
        return entityManager.createQuery("select new com.example.interviewmanagementsystem.util.dto.candidates.CandidateRecruiterDTO(r.recruiterName) from Candidates c join c.recruiter r where c.id=:id", CandidateRecruiterDTO.class)
                .setParameter("id",id)
                .getSingleResult();
    }
