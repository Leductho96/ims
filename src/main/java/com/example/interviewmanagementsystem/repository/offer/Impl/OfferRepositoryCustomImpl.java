package com.example.interviewmanagementsystem.repository.offer.Impl;
...
import com.example.interviewmanagementsystem.repository.offer.OfferRepositoryCustom;
...
public class OfferRepositoryCustomImpl implements OfferRepositoryCustom {
    ...
    public OfferCandidateListDTO getCandidateById(Integer id) {
        return entityManager.createQuery("select new com.example.interviewmanagementsystem.util.dto.offer.OfferCandidateListDTO(c.fullName,c.email) from Offer o join o.candidate c where o.id=:id",OfferCandidateListDTO.class)
                .setParameter("id",id)
                .getSingleResult();
    }
    ...
    public List<DepartmentListDTO> getDepartmentById(Integer id) {
        return entityManager.createQuery("select new com.example.interviewmanagementsystem.util.dto.offer.DepartmentListDTO(d.departmentName) from Offer o join o.department d where o.id=:id",DepartmentListDTO.class)
                .setParameter("id",id)
                .getResultList();
    ...
    public OfferUserListDTO getUserById(Integer id) {
        return entityManager.createQuery("select new com.example.interviewmanagementsystem.util.dto.offer.OfferUserListDTO(u.fullName) from Offer o join o.approvedBy u where o.id=:id",OfferUserListDTO.class)
                .setParameter("id",id)
                .getSingleResult();
    }
}
