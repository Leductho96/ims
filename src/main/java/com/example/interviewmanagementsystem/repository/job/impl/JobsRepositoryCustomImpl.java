package com.example.interviewmanagementsystem.repository.job.impl;
...
import com.example.interviewmanagementsystem.repository.job.JobsRepositoryCustom;
...
public class JobsRepositoryCustomImpl implements JobsRepositoryCustom {
    ...
    public List<SkillListDTO> getSkillsById(Integer id) {
        return entityManager.createQuery("select new com.example.interviewmanagementsystem.util.dto.jobs.SkillListDTO(s.skillName) from Jobs j join j.skillsSet s where j.id = :id", SkillListDTO.class)
                .setParameter("id", id)
                .getResultList();
    }
    ...
    public List<LevelListDTO> getLevelsById(Integer id) {
        return entityManager.createQuery("select new com.example.interviewmanagementsystem.util.dto.jobs.LevelListDTO(l.levelName) from Jobs j join j.levelsSet l where j.id = :id", LevelListDTO.class)
                .setParameter("id", id)
                .getResultList();
    }
